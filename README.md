...
Для повышения отказоустойчивости используем пассивную проверку бэкендов в `nginx`, настроив оптимальные timeout'ы.

Также, учитывая проблемы `nginx` с чтением больших конфигов, будем оптимизировать написанные конфиги.
